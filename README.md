...
preflight for them shows other values — an ERC-8004 id of `8453:999999918`, which does not exist,
a different `x402WalletAddress` per workflow, and the frozen wallet `0x0C3A…14B5` as owner. Those
are platform placeholders and the account's original sign-in wallet; the 402 challenge itself is
what a payment follows, and it names `0x6328…7911`.
