...
| | |
|---|---|
| **Settled x402 payment** | [`0x50124847…6b96b`](https://basescan.org/tx/0x50124847a9228521b829e3b47a2b098f5688e57d147e33764232c4c8f686b96b) — 0.01 USDC, buyer `0x09f5…b5B5` → seller `0x0C3A…14B5`, method `transferWithAuthorization`. The buyer spent **zero ETH**: x402 settles via an EIP-3009 signature and a relayer pays the gas. **Five** have settled at $0.01; this is the one whose reply carries the `checks` block, so the refusal-completeness fix is visible in the thing a buyer actually pays for. The seller in the first four is the wallet of frozen identity `95265`, whose key was lost, so those 0.04 USDC cannot be moved. The fifth, [`0xb852b0f5…63e8`](https://basescan.org/tx/0xb852b0f5e0d9f7e789fe78bc3de223066aaf33a91d6f93f8039e4f7fe81e63e8) (the demo film's NVDA position), and the $0.25 settlement below paid the current payTo, `0x6328…7911`. Both buyers are wallets this project created — that is a working rail, not demand, and [/pricing](https://assay-steel.vercel.app/pricing) says so. |
